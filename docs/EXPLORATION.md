# Lineage Lit - Fun Exploration Ideas
...
- **Beats:** Kerouac, Ginsberg, Burroughs
...
**Revenue hook:** "Explore the literary family tree of your favorite author"

---

## Sitcom Teleplay Lineage
...
**Revenue hook:** "Who wrote your favorite episode? Trace their career!"
...
**Reward:** Badges, reputation scores, early access to features
...
- **Timeline views:** See influences by decade

**Example:**
1920s: Hemingway, Fitzgerald, Stein (Paris)
→ 1940s: Kerouac (reads Hemingway)
→ 1950s: Beat Generation
→ 1970s: Hunter S. Thompson (Gonzo)
...
## Keep It Fun Principles

- **No deadlines** - explore at leisure
- **No minimums** - one beautiful visualization beats 100 rushed ones
- **Follow curiosity** - if Hemingway leads to fishing, that's fine
- **Share discoveries** - tweet interesting lineage finds
- **Make it pretty** - beautiful charts get shared

---

## Tools to Use

- **Project Gutenberg:** Free text downloads
- **OpenAI API:** Extract influence relationships from prefaces/acknowledgments
- **D3.js:** Beautiful interactive visualizations
- **Claude/Cursor:** Help with data extraction

---

## First Fun Task

**Goal:** Create ONE beautiful "Creative DNA" card
...
- Cool quote about writing

**Share it:** Screenshot for Twitter/LinkedIn

**Time:** 30 minutes max

---

Ready to explore? Or want to rest after 13 hours of work?
