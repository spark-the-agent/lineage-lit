  ...
  const stats = [
    {
      ...
      description: "Creators in network",
    },
    {
      label: "Edges",
      value: metrics.totalEdges,
      description: "Influence connections",
    },
    {
      label: "Density",
    ...
    },
    {
      ...
      description: "Connections per creator",
    },
  ];
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
      {stats.map((stat) => (
        <div
          key={stat.label}
          className="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700 text-center"
        >
