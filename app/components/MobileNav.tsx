        ...
        <div className="flex items-center justify-between px-4 h-14">
          ...
          <div className="flex items-center">
            {showBackButton ? (
              ...
              <Link
                href="/"
                className="flex items-center gap-2 min-h-[44px] -ml-2 px-2 rounded-lg"
              >
                ...
                <span className="font-bold bg-linear-to-r from-amber-400 to-orange-500 bg-clip-text text-transparent">
                  Lineage
                </span>
              </Link>
            )}
