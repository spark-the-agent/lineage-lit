...
export const metadata: Metadata = {
  ...
  description:
    "Discover writers and their creative lineage. Trace influences from Hemingway to Carver, Faulkner to McCarthy, and beyond.",
  openGraph: {
    title: "Explore Creators - Lineage Lit",
    description:
      "Discover writers and their creative lineage. Trace influences across generations of literature.",
  },
};
