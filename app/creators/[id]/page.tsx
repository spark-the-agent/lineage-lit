        ...
        <div className="bg-zinc-900/50 rounded-2xl p-4 sm:p-6 lg:p-8 border border-zinc-800 mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-4 sm:mb-6">
            <div className="min-w-0">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-amber-400 mb-1 sm:mb-2">
                {creator.name}
              </h2>
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="bg-amber-500/10 border-2 border-amber-500 rounded-xl p-4 sm:p-6 w-full sm:min-w-[200px] sm:w-auto text-center">
              ...
              <h4 className="font-semibold text-amber-400 text-sm sm:text-base">
                {creator.name}
              </h4>
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0 flex-1">
                    <h4 className="font-semibold text-zinc-200 text-sm sm:text-base truncate">
                  ...
                  <span className="px-2 py-1 bg-zinc-800 rounded text-xs text-zinc-400 shrink-0">
                    {work.type}
                  </span>
                </div>
...
function LineageCard({
  ...
  return (
    <Link href={`/creators/${creator.id}`} className="block">
      ...
      >
        <h4
          className={`font-medium text-sm ${type === "descendant" ? "text-amber-400" : "text-zinc-300"} truncate`}
        >
          {creator.name}
        </h4>
